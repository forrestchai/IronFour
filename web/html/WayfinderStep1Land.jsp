    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-6">
                ...
                <p class="text-center">Lorem ipsum dolor sit amet, consectetur adipisici elit,  </p>
            </div>
            <div class="col-xs-6">
                <a href="#">
                    <img src="http://pingendo.github.io/pingendo-bootstrap/assets/placeholder.png" class="img-responsive"></a>
                <p class="text-center">Lorem ipsum dolor sit amet, consectetur adipisici elit, <br> </p>
            </div>
        </div>
    </div>
</div>
